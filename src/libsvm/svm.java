					...
					svm_parameter param)
	{
		switch(param.kernel_type)
		{
			...
			case svm_parameter.RBF:
			{
				...
				return Math.exp(-param.gamma*sum);	//sum is || xi-xj ||^2
			}
			case svm_parameter.SIGMOID:
...
//		System.out.println("get_C:"+get_C(i));
//		
...
//		System.out.println("In Solve function...");
...
//		System.out.println("In solve_c_svc function...");
...
//		System.out.println("In svm_train_one function...");
...
//		System.out.println("In svm_train function...");
...
//		System.out.println(prob.toString());
		...
		System.out.println("Traing time : "+diffSeconds+"(s)");
